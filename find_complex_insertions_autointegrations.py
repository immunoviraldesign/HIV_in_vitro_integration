        ...
        if toks[5].count("M") == 1 and toks[5].count("S") == 1:
            ...
            if toks[5][-1] == "M":
                ...
                if int(toks[3]) > 20: 
                    ...
                    flanking3 = str(ref['HIV1_reference_crop_1000_9000'][begin:end]) 
                    flanking5 = str(ref['HIV1_reference_crop_1000_9000'][left:begin])
                    ...
                    tail = (20 - begin) * -1
                    flanking3 = str(ref['HIV1_reference_crop_1000_9000'][0:end])
                    flanking5 = str(ref['HIV1_reference_crop_1000_9000'][tail:])
                    flanking = str(flanking5+flanking3)
            ...
            # REVERSE insertions (mapped region in the left portion of the read means HIV LTR in the right)
                ...
                # find the reference sequence after the LTR
                if insertion > 20 and insertion <= 9710:
                    m += 1 
                    ...
                    h += 1
                    if insertion == 9730: # special case: the insertion is exactly between the end and the begining of pk184
                        flanking5 = str(ref['HIV1_reference_crop_1000_9000'][9710:9730])
                        flanking3 = str(ref['HIV1_reference_crop_1000_9000'][0:20])
                        flanking = str(flanking5+flanking3)
                    
                    else:
                        begin = insertion - 1 # the first base to pull from the reference (SeqIO is 0 based index)
                        left = begin - 20
                        flanking3 = str(ref['HIV1_reference_crop_1000_9000'][begin:])
                        flanking_looped = str(ref['HIV1_reference_crop_1000_9000'][:20-len(flanking3)])
                        flanking5 = str(ref['HIV1_reference_crop_1000_9000'][left:begin])
            ...
            # REVERSE insertions 
                ...
                if insertion > 20 and insertion <= 9710:
                    ...
                    # when the insertion point is greater than the length of the plasmid 
                        ...
                        begin = insertion - 9730 # the first base to pull from the reference (SeqIO is 0 based index)
                        end = begin + 20 # the last base to pull from the reference
                        tail = (20 - begin) * -1
                        flanking3 = str(ref['HIV1_reference_crop_1000_9000'][0:end])
                        flanking5 = str(ref['HIV1_reference_crop_1000_9000'][tail:])
